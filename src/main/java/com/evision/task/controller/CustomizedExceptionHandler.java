...
public class CustomizedExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public  Response<Object> handleInvitationCreationException(Exception ex, WebRequest request) {
	...
	public  Response<Object> handleAccessDeniedException(Exception ex, WebRequest request) {
	...
	public  Response<Object> handleExceptions(Exception ex, WebRequest request) {
